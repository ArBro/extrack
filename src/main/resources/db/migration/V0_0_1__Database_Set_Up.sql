...
create table TRANSACTION_CATEGORY (
	TRC_CATEGORY_NO bigint not null auto_increment, 
...
alter table TRANSACTION add constraint FK_TRANSACTION_CATEGORY foreign key (TRA_CATEGORY_CODE) references TRANSACTION_CATEGORY (TRC_CATEGORY_NO);
